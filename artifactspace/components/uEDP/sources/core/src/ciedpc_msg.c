 ...
 */
static ciedpc_msg_t blank_pool[CIEDPC_MSG_BLANK_QUEUE_SIZE] = {0};
 ...
 * 
 */
static ciedpc_msg_t alloc_pool[CIEDPC_MSG_ALLOC_QUEUE_SIZE] = {0};
static ui8 alloc_pool_data[CIEDPC_MSG_ALLOC_QUEUE_SIZE][CIEDPC_MSG_ALLOC_DATA_MAX] = {0};
 ...
 * 
 */
static ciedpc_msg_t extal_pool[CIEDPC_MSG_EXTAL_QUEUE_SIZE] = {0};
static ui8 extal_pool_data[CIEDPC_MSG_EXTAL_QUEUE_SIZE][CIEDPC_MSG_EXTAL_DATA_MAX] = {0};
ciedpc_msg_pool_header_t g_extal_pool_ctrl = {0};

/**
 * @brief ISR pool với kích thước là 16 sizeof(ciedpc_msg_isr_t) units
 */
ciedpc_msg_isr_t isr_pool_buffer[CIEDPC_MSG_ISR_QUEUE_SIZE] = {0};
fifo_t isr_pool = {0};
